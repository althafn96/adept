    ...
    <x-slot name="header">
        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
            ...
            <div class="ml-4 mt-4 flex-shrink-0">
                <a href="{{ route('verticals.create') }}" type="button"
                ...
                var table = $('#vendors_table').DataTable( {
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full, meta) {
                                    return '\
                                        <a href="verticals/'+full.id+'/edit" type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white-700 bg-white hover:bg-orange-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">\
                                            Edit\
                                        </a>\
                                        <form method="POST" class="inline-flex" action="verticals/'+full.id+'">\
                                        @csrf\
                                        @method("DELETE")\
