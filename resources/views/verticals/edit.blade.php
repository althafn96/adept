            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="bg-white">
                    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                        ...
                        <form method="POST" action="{{ route('verticals.update', [$vertical]) }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data">
                                ...
                                <div
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <textarea id="description" name="description" rows="3"
                                            class="max-w-lg shadow-sm block w-full focus:ring-adeptred-1 focus:border-adeptred-1 sm:text-sm border-gray-300 rounded-md">{{ $vertical->description }}</textarea>
                                ...
                                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <select id="status" name="status" class="max-w-lg block focus:ring-adeptred-1 focus:border-adeptred-1 w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <option {{ $vertical->status == '1' ? 'selected' : '' }}  value="1">Enabled</option>
                                            <option {{ $vertical->status == '0' ? 'selected' : '' }} value="0">Disabled</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
