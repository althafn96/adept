                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <select multiple id="areas" name="areas[]"
                                            ...
                                            @foreach ($districts as $district)
                                                <option {{ in_array($district->id, $member_areas) ? 'selected' : '' }} value="{{ $district->id }}">{{ $district->title }}</option>
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <select multiple id="specializations" name="specializations[]"
                                            ...
                                            @foreach ($specializations as $specialization)
                                                <option {{ in_array($specialization->id, $member_specializations) ? 'selected' : '' }}  value="{{ $specialization->id }}">{{ $specialization->title }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <select id="rvsa_unit_id" name="rvsa_unit_id"
                                            ...
                                            @foreach ($units as $unit)
                                                <option {{ $member->rvsa_unit_id == $unit->id ? 'selected' : '' }} value="{{ $unit->id }}">{{ $unit->title }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <select id="status" name="status"
                                            class="max-w-lg block focus:ring-adeptred-1 focus:border-adeptred-1 w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <option {{ $member->status == '1' ? 'selected' : '' }} value="1">Enabled</option>
                                            <option {{ $member->status == '0' ? 'selected' : '' }} value="0">Disabled</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
