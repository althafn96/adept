            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <table style="width: 100%" id="vendors_table" class="min-w-full divide-y divide-gray-200 stripe hover">
            ...
            $(document).ready(function() {
                ...
                var table = $('#vendors_table').DataTable( {
                        ...
                        columns: [
                            ...
                            {data: 'rvsa_unit'},
                            {data: 'address'},
                            {data: 'other_skills_experience_and_qualifications'},
                            {data: 'status'},
                            {data: 'actions'},
                        ],
                        columnDefs: [
                            ...
                            {
                                targets: 2,
                                class: 'px-6 py-4 whitespace-nowrap text-sm text-gray-500 w-20',
                            },
                            {
                                targets: 3,
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full, meta) {
                                    return '\
                                        <a href="members/'+full.id+'/edit" type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white-700 bg-white hover:bg-orange-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">\
                                            Edit\
                                        </a>\
                                        <form method="POST" class="inline-flex" action="members/'+full.id+'">\
                                        @csrf\
                                        @method("DELETE")\
