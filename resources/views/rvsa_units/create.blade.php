            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="bg-white">
                    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                        ...
                        <form method="POST" action="{{ route('rvsa-units.store') }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data">
                                                    ...
                                                    <div class="mt-4 space-y-4">
                                                        <div class="flex items-center">
                                                            <input id="level1" name="type"
                                                                {{ old('type') == 'level1' ? 'checked' : '' }}
                                                                {{ old('type') == 'level2' ? '' : 'checked' }}
                                                                value="level1"
                                                                type="radio"
                                ...
                                <div
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <select id="province_id" name="province_id"
                                            ...
                                            <option {{ old('province_id') == '1' ? 'selected' : '' }} value="1">Western Province</option>
                                            <option {{ old('province_id') == '2' ? 'selected' : '' }} value="2">Central  Province</option>
                                            <option {{ old('province_id') == '3' ? 'selected' : '' }} value="3">Southern  Province</option>
                                            <option {{ old('province_id') == '4' ? 'selected' : '' }} value="4">Uva Province</option>
                                            <option {{ old('province_id') == '5' ? 'selected' : '' }} value="5">Sabaragamuwa Province</option>
                                            <option {{ old('province_id') == '6' ? 'selected' : '' }} value="6">North Western  Province</option>
                                            <option {{ old('province_id') == '7' ? 'selected' : '' }} value="7">North Central Province</option>
                                            <option {{ old('province_id') == '8' ? 'selected' : '' }} value="8">Nothern  Province</option>
                                            <option {{ old('province_id') == '9' ? 'selected' : '' }} value="9">Eastern Province</option>
                                        </select>
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <select id="district_id" name="district_id"
                                            ...
                                            @foreach ($districts as $district)
                                                <option {{ old('district_id') == $district->id ? 'selected' : '' }} value="{{ $district->id }}">{{ $district->title }}</option>
                                            @endforeach
                                        </select>
